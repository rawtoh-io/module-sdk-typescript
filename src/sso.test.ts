...
import { authMode, fetchUserByCookie } from "./sso"

const me = {
  user: { id: "u1", name: "Ada", email: "ada@x.io", image: null },
  organizations: [
    { id: "o1", name: "Org", slug: "org", logo: null, role: "owner" },
  ],
}
...
describe("cookie SSO", () => {
  ...
  test("maps /api/me to the userinfo shape and caches per cookie", async () => {
    ...
    expect(await fetchUserByCookie("sid=a")).toEqual({
      sub: "u1",
      name: "Ada",
      email: "ada@x.io",
      picture: undefined,
      organizations: [
        { id: "o1", name: "Org", slug: "org", logo: undefined, role: "owner" },
      ],
    })
